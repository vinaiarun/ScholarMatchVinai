            ...
            User.findById(options.userid, function (err, user) {
             ...
             console.log('111aaa');
              if(err){
                    ...
                    user.emailId = options.emailId;
                    user.primaryPhone = options.primaryPhone;
                    user.alternativePhone = options.alternativePhone;
                    ...
                    user.preferredMeetingDays.sunday = options.preferredMeetingDays.sunday;
                    user.preferredMeetingDays.monday = options.preferredMeetingDays.monday;
                    user.preferredMeetingDays.tuesday = options.preferredMeetingDays.tuesday;
                    user.preferredMeetingDays.wednesday = options.preferredMeetingDays.wednesday;
                    user.preferredMeetingDays.thursday = options.preferredMeetingDays.thursday;
                    user.preferredMeetingDays.friday = options.preferredMeetingDays.friday;
                    user.preferredMeetingDays.saturday = options.preferredMeetingDays.saturday;
                    user.linkedinUrl = options.linkedinUrl;   
